...
export const DefaultEndPoint: string = 'https://radarbase.gsi.upm.es'
...
export const FCMPluginProjectSenderId: string = '138363236360'
...
export const DefaultProtocolGithubRepo = 'ecariel/RADAR-aRMT-protocols'
...
export const DefaultSchemaGithubRepo = 'ecariel/RADAR-Schemas'
